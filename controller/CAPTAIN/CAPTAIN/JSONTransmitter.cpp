...
void JSONTransmitter::TransmitFromNav(std::string const path)
{	
	...
	std::vector<Coordinate> completed_path_coordinates_vector = nav_data.Completed_path_;
	std::vector<Coordinate> path_coordinates_vector = nav_data.Path_;
